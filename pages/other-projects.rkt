...
(define page
  (document
    ...
    (section "编程语言 Scheme"
      (section "SICP 解题集"
        (paragraph "在线阅读：" (hyperlink "链接" "https://call-cc.cc/sicp-solutions/"))
      ...
      (section "数据导向的 Scheme 教程"
        (paragraph "在线阅读：" (hyperlink "链接" "https://call-cc.cc/scheme-tutorial/"))
    ...
    (section "其他"
      (section "北邮 2025 年春计科转专业机试题"
        (paragraph "在线阅读：" (hyperlink "链接" "https://call-cc.cc/bupt-major-switching-programming-questions/"))
