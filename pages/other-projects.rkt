    ...
    (section "编程语言 Scheme"
      (section "SICP 解题集"
        (itemize
          ...
          (list "此网页属于另一 GitHub 仓库。仓库链接：" (hyperlink "sicp-solutions" "https://github.com/LS-Hower/sicp-solutions")))
      ...
      (section "数据导向的 Scheme 教程"
        (itemize
          ...
          (list "此网页属于另一 GitHub 仓库。仓库链接：" (hyperlink "scheme-tutorial" "https://github.com/LS-Hower/scheme-tutorial")))
